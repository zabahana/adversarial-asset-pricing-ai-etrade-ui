"""
Visualize DQN Comparison Results
"""
...
fig.suptitle('Standard DQN vs Attention-Enhanced DQN Comparison\n5 Stocks, 30 Episodes Each, Monthly Data', 
...
# 5. Detailed Stock-by-Stock Comparison
...
columns = ['Stock', 'Standard DQN', 'Attention DQN', 'Buy & Hold', 'Winner']
table = ax5.table(cellText=cell_text, colLabels=columns,
...
for i in range(1, len(cell_text) + 1):
    if i == len(cell_text):  # Average row
        ...
        winner_cell = table[(i, 4)]
        if '🧠' in cell_text[i-1][4]:
            winner_cell.set_facecolor('#d5f4e6')
        else:
            winner_cell.set_facecolor('#d6eaf8')

ax5.axis('off')
ax5.set_title('Detailed Comparison Table', fontweight='bold', 
              fontsize=14, pad=20)

plt.tight_layout()
plt.savefig('dqn_comparison_results.png', dpi=300, bbox_inches='tight', 
            facecolor='white', edgecolor='none')
print("\n✓ Saved: dqn_comparison_results.png")
...
print("="*80)
print("\nGenerated files:")
print("  📊 dqn_comparison_results.png")
print("  📄 dqn_comparison_report.txt")
print("="*80)
